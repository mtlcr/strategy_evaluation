...
def compute_portvals(
    ...
    price_df = get_data(["JPM"], pd.date_range(start_date, end_date))
    # print('price_df: \n', price_df)
    # print('price_df type: \n', type(price_df))
    # print('price df index ', price_df.index)
    # remove SPY
    ...
    price_df['Cash'] = 1.0
    price_df['Cash'] = price_df['Cash'].to_frame()
    # print('\nprice_df added cash symbol: \n', price_df)
    # print('price_df[Cash] type: \n', type(price_df['Cash']))
    ...
    # print('\norder_df: \n', order_df)
    #
    # order_df['Date'] = order_df.index
    # print('order_df    ' ,order_df )
    # print('order_df  type  ' ,type(order_df ))
    # order_df = order_df.to_frame()
