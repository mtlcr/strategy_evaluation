...
def exp1_insample(symbol, sv, commission,impact):
    ...
    fig, ax = plt.subplots()
    ax.set_title("JPM - In Sample - Manual vs. Strategy Learner")
    ...
    plt.savefig('images/Experiment 1 In Sample.png')
    plt.clf()


def exp1_outsample(symbol, sv, commission,impact):
    ...
    fig, ax = plt.subplots()
    ax.set_title("JPM - Out of Sample - Manual vs. Strategy Learner")
    ax.set_ylabel('Normalized Portfolio Value',size = 8)
    ax.set_xlabel('Date',size = 8)
    # ax.grid(which='major', color='#DDDDDD', linewidth=0.8)
    # ax.grid(which='minor', color='#EEEEEE', linestyle=':', linewidth=0.5)
    ...
    ax.legend()
    # plt.xticks(rotation=25)
    plt.savefig('images/Experiment 1 Out of Sample.png')
    plt.clf()
def author():
  return ''

if __name__ == "__main__":
    exp1_insample(symbol = "JPM",  sv = 100000, commission = 9.95,impact = 0.005)
    exp1_outsample(symbol = "JPM",  sv = 100000, commission = 9.95,impact = 0.005)